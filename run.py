...
def cmd_render() -> None:
    ...
    except pipeline.StatsCorrupt:
        print("Nothing to render yet — no successful fetch has happened.")
        print("Run `python run.py update` (or `python find-internships.py`) first.")
        sys.exit(1)
