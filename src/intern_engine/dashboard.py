...
<meta name="description" content="Summer 2027 & Fall 2026 mechanical engineering internships, refreshed every 30 minutes. Auto-detected visa sponsorship flags, proven H-1B sponsor badges, email alerts.">
<meta property="og:title" content="Internship Engine - Live Dashboard">
<meta property="og:description" content="{len(open_jobs)} open mechanical engineering internships, refreshed every 30 minutes. Visa-sponsorship flags + proven H-1B sponsor badges for international students.">
...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  <header class="top">
    <h1>{escape(region)} mechanical engineering internships</h1>
