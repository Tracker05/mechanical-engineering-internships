...
def _header(cfg: dict, total_open: int, companies: int, new_week: int,
    ...
    return [
        '<div align="center">',
        "",
        "# \U0001F527 Summer 2027 Mechanical Engineering Internships",
        "",
        "**A self-updating engine that tracks mechanical engineering internships "
        "so you don't have "
        "to.**",
        "",
        ...
        "| | |",
        "|---|---|",
        "| **Roles** | Mechanical Design, Manufacturing, Thermal/Fluids, "
        "Automotive, Aerospace, Robotics & Controls, Structures & Materials, "
        "Energy, Test & Quality "
...
def generate(store_data: dict, data_as_of: str | None = None) -> dict:
    ...
    if rolling_rows:
        lines.extend([
            ...
            "posting text — so neither do we. They're recent mechanical internships "
